    ...
    if (state_ == wExpectRequestLine) {
      ...
      if (crlf) {
        ...
        if (colon < crlf) {
          ...
          if (request_.method() == HttpRequest::wPost ||
              request_.method() == HttpRequest::wPut) {
